  ...
  return (
    <article className="service-card">
      <Link to={`/services/${service.slug}`} className="service-image">
        <img src={service.imageUrl || '/pics/product-placeholder.jpg'} alt={service.title} loading="lazy" onError={(e) => { e.target.src = '/pics/product-placeholder.jpg'; e.target.onerror = null; }} />
        {service.featured && (
